---
type: index
title: "oriz-janaushdhi-app — knowledge bundle"
description: "App-specific knowledge for oriz-janaushdhi-app. Cross-cutting family rules live at master `c:/D/oriz/knowledge/`."
tags: [okf, index, app, janaushdhi]
timestamp: 2026-06-21
format_version: okf-v0.1
status: active
---

# oriz-janaushdhi-app — knowledge bundle

This is the per-app OKF-light bundle for **oriz-janaushdhi-app**. App-specific facts only. Cross-cutting family rules / decisions / services live at master [`../../../../knowledge/`](../../../../knowledge/).
...
- **Category**: content
- **Family role**: Read-only catalog of the PMBJP generic medicine list — search, filter, and compare prices.
